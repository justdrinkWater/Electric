...
<tr>
		...
		<tr>
			...
			<option value="13" selected>海南台</option>	
		...
		<tr>
			...
			<option value="5" selected>天线</option>	
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff">
			<input name="occurDate" type="text" id="occurDate" size=20 onClick="setDayHM(this);" value="2008-12-10 21:12">					
		...
		<tr>
			...
			<input name="resolveDate" type="text" id="resolveDate" size="20" onfocus="setDayHM(this);"  value="2008-12-31 23:00">			
			</td>
