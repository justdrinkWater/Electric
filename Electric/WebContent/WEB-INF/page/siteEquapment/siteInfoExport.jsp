...
<script type="text/javascript">
	...
	function checksubmit() {
		...
		$.ajax({  
	        type : "POST",  
	        url : "siteEquapment/elecStationAction_setExportExcel.do",
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
					...
					<table border="0" width="100%" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td width="84%" colspan="4">
								<table border="0" width="100%" cellspacing="0" cellpadding="0">
									<tr>
										<td width="30%" rowspan="4"><select size="15"
										...
										<td width="15%"></td>
										<td width="35%" rowspan="4" id="colnameDiv"><select
			...
			<tr>
				<td align="center"><INPUT type="button" name="save" id="save"
					...
					value="关闭" id="Reset1" name="Reset1" onclick="window.close();"></td>
			</tr>
		</table>
	</s:form>
</body>
