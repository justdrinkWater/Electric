...
<tr>
		...
		<tr>
			...
			<option value="4" selected>厦门台</option>	
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff">
			<input name="occurDate" type="text" id="occurDate" size=20 onClick="setDayHM(this);" value="2005-11-30 17:12">					
		...
		<tr>
			...
			<input name="resolveDate" type="text" id="resolveDate" size="20" onfocus="setDayHM(this);"  value="2008-01-30 23:00">			
			</td>
