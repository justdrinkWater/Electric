...
<html lang="zh-CN">
  <head>
    <base href="http://localhost:8090/DRMS/station/excelImport.jsp">   
    <title>导入文件</title> 
  ...
  <body onload="successInit()">
    <form name="importForm" method="post" action="/DRMS/station/excelImport.do" enctype="multipart/form-data">
      <br>
