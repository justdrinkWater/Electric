...
<script type="text/javascript">
		...
		if (document.Form1.keyword.value == "jerrynew") {
			...
			Pub
					.submitActionWithForm(
							'Form2',
							'${pageContext.request.contextPath }/system/elecDictionaryAction_edit.do',
							'Form1');
	...
	function saveDict() {
		...
		document.Form2.action = "${pageContext.request.contextPath }/system/elecDictionaryAction_save.do";
		...
		<table cellSpacing="1" cellPadding="0" width="90%" align="center"
			...
			<TBODY>
				...
				<tr>
					...
					<td class="ta_01" align="left" width="30%"><s:select
							list="%{#request.dicLsit}" name="keyword" cssClass="bg"
							id="keyword" cssStyle="width: 180px" onchange="changetype()"
							headerKey="jerrynew" headerValue="" listKey="keyword"
							listValue="keyword" /></td>
				...
				<TR height=10>
					<td colspan=3 align="right"><input type="button"
						...
						style="font-size: 12px; color: black;" onClick="insertRows()">
					</td>
				</TR>
			</TBODY>
		</table>
		...
		<table cellSpacing="1" cellPadding="0" width="90%" align="center"
			...
			<tr>
				<td align="center" colspan=3><input type="button"
					name="saveitem" value="保存" style="font-size: 12px; color: black;"
					onClick="saveDict()"></td>
			</tr>
