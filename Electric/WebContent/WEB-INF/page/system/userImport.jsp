...
<SCRIPT type="text/javascript">
	function checkFile() {
	    ...
	    document.Form1.action="system/elecUserAction_importExcel.do";
	    document.Form1.submit();
	    alert("上传成功！！");
/* 	    $.ajax({  
            type : "POST",  
            url : "${pageContext.request.contextPath }/system/elecUserAction_importExcel.do",  
...
<body>
	<s:form action="system/elecUserAction_importExcel.do" method="post"
