...
<body>
	<br>
	<form name="Form1" action="uploadFile.do" method="post" enctype="multipart/form-data">
					...
					<td class="ta_01" align="center" bgColor="#f5fafe" colspan=3>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr onMouseOver="this.style.backgroundColor = 'white'"
								...
								<td align="center"><a
									href="delFileECC.do?deleteZr=1&action=Z&fileName=DG_2010V33_1112.exe&projId="
