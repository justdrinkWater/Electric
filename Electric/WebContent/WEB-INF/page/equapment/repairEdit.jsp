...
<span  id=PPassword style="DISPLAY: none">
  <input style="font-size:12px; color:black; height=22;width=55" id="BT_Add" type="button" value="详细" name="BT_Add" onClick="openWindowWithName('EOCUpload.do?zr1=1&devId=c51da3d47c814b488d4a4206c7a1703f&projId=7235',800,450,'ECC');" />
</span>
</TD>
</TR>
...
<tr>
	...
	<input type="button" name="BT_Submit" value="保存"   onclick="return check();" id="BT_Submit" style="font-size:12px; color:black; height=22;width=55"  />
