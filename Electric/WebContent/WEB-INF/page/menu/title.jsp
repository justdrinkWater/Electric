...
<BODY>
	<FORM id=Form1 name=Form1 method=post>
		<table border="0" width="100%" height="9" cellspacing="0"
			...
			<tr>
				<td width="20%" height="25" bgcolor="#0965CA">
					<table border="0" width="100%" cellspacing="0" cellpadding="0">
						<tr>
							<td width="15%" align="center"><font color="#FFFFFF"><b>|</b></font></td>
							<td width="70%" align="center"><FONT color=#FFFFFF> <b>
				...
				<td width="16%" height="25" bgcolor="#0965CA">
				...
				<td width="46%" height="25" bgcolor="#0965CA"></td>
