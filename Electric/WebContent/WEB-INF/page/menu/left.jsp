...
<% HashMap roles = (HashMap)request.getSession().getAttribute("globle_roles"); %>
<HTML>
<HEAD>
<TITLE>Left</TITLE>
<STYLE type="text/css">
...
<BODY scroll="no" MS_POSITIONING="GridLayout" scroll="auto"
	class="bodyscroll">
			...
			<TR>
				...
				<%if(popedom.contains("a")||popedom.contains("b")||popedom.contains("c")){ %>
							...
							<TBODY>
								<TR height=25>
									<TD align="left"
										...
										name="imgKB0" width="9" height="9" alt="" border="0" />
										&nbsp; <A class="cl" onclick="expand('KB0'); return false"
										href="#">&nbsp;技术设施维护管理</A>
									</TD>
								</TR>
							</TBODY>
							...
							<%if(popedom.contains("a")){ %>
								...
								<TR>
									<TD class="box05"
										...
										href="${pageContext.request.contextPath }/equapment/elecDeviceAction_home.do"
										target="mainFrame">仪器设备管理</A></TD>
								</TR>
							...
							<TBODY>
								...
								<TR height=25>
									<TD
										...
										src="${pageContext.request.contextPath }/images/add.gif"
										name="imgKB1" width="9" height="9" alt="" border="0" />
										&nbsp; <A class="cl" onclick="expand('KB1'); return false"
										href="#">&nbsp;技术资料图纸管理</A>
									</TD>
								</TR>
							</TBODY>
							...
							<TBODY>
								<TR>
									<TD class="box05"
										...
										onmouseout="backgroundColorChange(this,'');"><A
										class="cl_01" onclick="linkcolorchange(this)"
										href="${pageContext.request.contextPath }/dataChart/dataChartIndex.jsp"
										target="mainFrame">资料图纸管理</A></TD>
								</TR>
							</TBODY>
						</TABLE>
					</DIV>
							...
							<TBODY>
								...
								<TR height=25>
									<TD
										...
										align="left" vAlign="middle">&nbsp;&nbsp;&nbsp;<img
										src="${pageContext.request.contextPath }/images/add.gif"
										name="imgKB2" width="9" height="9" alt="" border="0" />
										&nbsp; <A class="cl" onclick="expand('KB2'); return false"
										href="#">&nbsp;站点设备运行管理</A>
									</TD>
								</TR>
							</TBODY>
							...
							<TBODY>
								...
								<TR>
									<TD class="box05"
										...
										onmouseout="backgroundColorChange(this,'');"><A
										class="cl_01" onclick="linkcolorchange(this)"
										href="${pageContext.request.contextPath }/siteEquapment/siteRunIndex.jsp"
										target="mainFrame">运行情况</A></TD>
								</TR>
								...
								<TR>
									<TD class="box05"
										...
										onmouseout="backgroundColorChange(this,'');"><A
										class="cl_01" onclick="linkcolorchange(this)"
										href="${pageContext.request.contextPath }/siteEquapment/siteMaintainIndex.jsp"
										target="mainFrame">维护情况</A></TD>
								</TR>
								<%} %>
							</TBODY>
						</TABLE>
							...
							<TBODY>
								...
								<TR height=25>
									<TD
										...
										align="left" vAlign="middle">&nbsp;&nbsp;&nbsp;<img
										src="${pageContext.request.contextPath }/images/add.gif"
										name="imgKB3" width="9" height="9" alt="" border="0" />
										&nbsp; <A class="cl" onclick="expand('KB3'); return false"
										href="#">&nbsp;监测台建筑管理</A>
									</TD>
								</TR>
							</TBODY>
							...
							<TBODY>
								<TR>
									<TD class="box05"
										...
										onmouseout="backgroundColorChange(this,'');"><A
										class="cl_01" onclick="linkcolorchange(this)"
										href="${pageContext.request.contextPath }/building/buildingIndex.jsp"
										target="mainFrame">监测台建筑管理</A></TD>
								</TR>
							</TBODY>
						</TABLE>
					</DIV>
							...
							<TBODY>
								...
								<TR height=25>
									<TD
										...
										align="left" vAlign="middle">&nbsp;&nbsp;&nbsp;<img
										src="${pageContext.request.contextPath }/images/add.gif"
										name="imgKB4" width="9" height="9" alt="" border="0" />
										&nbsp; <A class="cl" onclick="expand('KB4'); return false"
										href="#">&nbsp;系统管理</A>
									</TD>
								</TR>
							</TBODY>
					...
					<DIV class="child" id="KB4Child">
						<TABLE cellSpacing="0" cellPadding="0" width="99%" border="0">
							<TBODY>
								<%if(roles.containsKey("1")||roles.containsKey("2")){ %>
								...
								<TR>
									<TD class="box05"
										...
										onmouseout="backgroundColorChange(this,'');"><A
										class="cl_01" onclick="linkcolorchange(this)"
										href="${pageContext.request.contextPath }/system/elecUserAction_home.do"
								...
								<TR>
									<TD class="box05"
										...
										onmouseout="backgroundColorChange(this,'');"><A
										class="cl_01" onclick="linkcolorchange(this)"
										href="${pageContext.request.contextPath }/system/elecUserAction_edit.do?userID=${globle_user.userID}&roleflag=1"
										target="mainFrame">用户管理</A></TD>
								</TR>
								...
								<TR>
									<TD class="box05"
										...
										onmouseout="backgroundColorChange(this,'');"><A
										class="cl_01" onclick="linkcolorchange(this)"
										href="${pageContext.request.contextPath }/system/elecUserRoleAction_home.do"
								...
								<TR>
									<TD class="box05"
										...
										onmouseout="backgroundColorChange(this,'');"><A
										class="cl_01" onclick="linkcolorchange(this)"
										href="${pageContext.request.contextPath }/system/elecActingAction_home.do"
										target="mainFrame">待办事宜</A></TD>
								</TR>
								...
								<TR>
									<TD class="box05"
										...
										onmouseout="backgroundColorChange(this,'');"><A
										class="cl_01" onclick="linkcolorchange(this)"
										href="${pageContext.request.contextPath }/system/elecDictionaryAction_home.do"
										target="mainFrame">数据字典维护</A></TD>
								</TR>
								<%}%>
								<TR>
									<TD class="box06"
