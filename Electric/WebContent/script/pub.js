...
Pub.getReadyStateHandler = function getReadyStateHandler(req, eleid,
		responseXmlHandler) {
...
Pub.getStatisticReadyStateHandler = function(req, eleid, responseXmlHandler,
		noteId) {
...
Pub.submitAction = function(domId, action) {
	...
	var handlerFunction = Pub.getReadyStateHandler(req, domId,
			Pub.handleResponse);
